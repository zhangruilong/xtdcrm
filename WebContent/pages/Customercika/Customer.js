Ext.onReady(function() {
	...
	var Customerstore = dataStore(Customerfields, basePath +"CuscardviewService.do?method=selQuery&wheresql=cuscardtypeclass='次数卡'");// 定义Customerstore
	...
	var Customergrid =  Ext.create('Ext.grid.Panel', {
		...
		tbar : [{
				text : Ext.os.deviceType === 'Phone' ? null : "新增(培训)销售机会",
				iconCls : 'add',
				handler : function() {
					...
					commonUpdAll(basePath + Customeraction + "?method=changestatue",selections,Customerstore,Customerkeycolumn,"培训");
				}
			},'-',{

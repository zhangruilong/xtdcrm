Ext.onReady(function() {
	var nextdate = getnextdate(new Date(),30);
	...
	var Customerstore = dataStore(Customerfields, basePath +"CuscardviewService.do?method=selQuery&wheresql=cuscardend<'"+nextdate+"'");// 定义Customerstore

Ext.onReady(function() {
	...
	var Customerstore = dataStore(Customerfields, basePath + Customeraction + "?method=selQuery&wheresql=customeremp='"+currentuser.username+"'");// 定义Customerstore
	...
	var Customergrid =  Ext.create('Ext.grid.Panel', {
		...
		tbar : [{
				text : Ext.os.deviceType === 'Phone' ? null : "新增销售机会",
				iconCls : 'add',
				handler : function() {
				...
				text : Ext.os.deviceType === 'Phone' ? null : "开发计划",
				iconCls : 'query',
				handler : function() {

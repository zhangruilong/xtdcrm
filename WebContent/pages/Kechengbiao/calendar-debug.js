...
Ext.define('Ext.calendar.form.AbstractForm', {
    ...
    privates: {
        ...
        onDropTap: function() {
	      ...
	      //保存到服务器
	        var json = "[" + Ext.encode(values) + "]";
			Ext.Ajax.request({
				url : "PlacetimeService.do?method=delAll",
				method : 'POST',
				params : {
					json : json
				},
...
//            values.calendarId = Ext.getCmp("calendarId").getValue().substring(28);
            ...
            var json = "[" + Ext.encode(values) + "]";
			Ext.Ajax.request({
				url : "PlacetimeService.do?method="+method,
				method : 'POST',
				params : {
					json : json
				},
    ...
    consumeEventData: function() {
        var me = this,
            ...
            data = {
                ...
                placetimecoachname: event.getPlacetimecoachname(),
...
Ext.define('Ext.calendar.model.Event', {
    ...
    getPlacetimeid: function() {
        return this.data.placetimeid;
    },
    ...
    setPlacetimeproject: function(placetimeproject) {
    	this.set('placetimeproject', placetimeproject);
    },
    getPlacetimeplacename: function() {
        return this.data.placetimeplacename;
    },
    setPlacetimeplacename: function(placetimeplacename) {
    	this.set('placetimeplacename', placetimeplacename);
    },
    getPlacetimedetail: function() {
        return this.data.placetimedetail;
    },
    setPlacetimedetail: function(placetimedetail) {
    	this.set('placetimedetail', placetimedetail);
    },
    getPlacetimecoachname: function() {
        return this.data.placetimecoachname;
    },
    setPlacetimecoachname: function(placetimecoachname) {
    	this.set('placetimecoachname', placetimecoachname);
    }
});

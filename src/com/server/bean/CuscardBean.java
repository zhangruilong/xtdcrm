 ...
 *@author ZhangRuiLong
 */
public class CuscardBean
{
	private String cuscardcustomernew;
	public String getCuscardtimesnew() {
		return cuscardtimesnew;
	}

	public void setCuscardtimesnew(String cuscardtimesnew) {
		this.cuscardtimesnew = cuscardtimesnew;
	}

	public String getCuscardendnew() {
		return cuscardendnew;
	}

	public void setCuscardendnew(String cuscardendnew) {
		this.cuscardendnew = cuscardendnew;
	}
	...
	private String cuscardtimesnew;
	private String cuscardendnew;
   ...
   private String cuscardupdwho;   
	...
	public CuscardBean(String cuscardcustomernew, String cuscardtimesnew, String cuscardendnew, String cuscardnonew,
			String cuscardid, String cuscardcustomer, String cuscardstadium, String cuscardno, String cuscardtypename,
			String cuscardtypeclass, String cuscardday, String cuscardbegin, String cuscardend, String cuscardprice,
			String cuscarddikou, String cuscardmoney, String cuscardstop, String cuscardstopmoney, String cuscardtimes,
			String cuscardpoint, String cuscarddetail, String cuscardchangci, String cuscardproject,
			String cuscardstatue, String cuscardinswhen, String cuscardinswho, String cuscardupdwhen,

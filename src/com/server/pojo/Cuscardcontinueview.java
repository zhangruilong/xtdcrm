...
/**
 * cuscardcontinueview 实体类
 *@author ZhangRuiLong
 */
public class Cuscardcontinueview
{
   /**
    * ID,主键
    */
    ...
    * 卡新余额
    */
   private Double cuscardmoneynew;   
   /**
    * 卡新总次数
    */
   private Integer cuscardnumsnew;   
   /**
    * 卡新余次
    */
   private Integer cuscardtimesnew;   
   /**
    * 卡积分
    */
   ...
   private String customerphone;   
	 ...
	 */
	public void setCuscardmoneynew(Double cuscardmoneynew)
	{
	 ...
	 *获取"卡新余额"属性
	 */
	public Double getCuscardmoneynew()
	{
	 ...
	 */
	public void setCuscardnumsnew(Integer cuscardnumsnew)
	{
	 ...
	 *获取"卡新总次数"属性
	 */
	public Integer getCuscardnumsnew()
	{
	 ...
	 */
	public void setCuscardtimesnew(Integer cuscardtimesnew)
	{
	 ...
	 *获取"卡新余次"属性
	 */
	public Integer getCuscardtimesnew()
	{
	...
	public Cuscardcontinueview(
		String cuscardid
	 	...
	 	,Double cuscardmoneynew
	 	,Integer cuscardnumsnew
	 	,Integer cuscardtimesnew
	 	,Integer cuscardint
